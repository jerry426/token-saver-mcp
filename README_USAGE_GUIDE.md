...
Token Saver MCP provides **30 tools** organized by category:
- **13 LSP tools** - Code navigation and intelligence
...
Search for text across all files in the workspace. Returns file locations and positions that can be used with other tools like get_definition or get_references.
